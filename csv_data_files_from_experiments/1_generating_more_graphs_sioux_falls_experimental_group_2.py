######### 1_generating_more_graphs_sioux_falls.py #################
...
for player in number_of_players:
    for alpha in type_of_alpha:
        ...
        name_of_data = "data_saving_experiment_Sioux_Falls"+\
...
test.set_title("Flow Error for SF: Same Parameters and 10 Trials for Each Experiment")
#pdb.set_trace()
...
plt.title("Normalized Flow Error for SF: Same Parameters and 10 Trials for Each Experiment")
plt.xticks(rotation=45)
...
plt.title("Timing for SF: Same Parameters and 10 Trials for Each Experiment")
plt.xticks(rotation=45)
...
plt.title("Objective Function Values for SF: Same Parameters and 10 Trials for Each Experiment")
plt.xticks(rotation=45)
