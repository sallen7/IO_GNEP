...
for i = 1:num_trials
    ...
    IO_costs_c_hat_mat = IO_costs_c_hat_mat;
    
    iwgdx(sprintf('IO_traffic_data_gdx_iteration_%d',i),'IO_costs_c_mat',...
        'IO_costs_c_hat_mat','node_arc_incidence','num_arcs','num_nodes',...
        'num_players','alpha')
end